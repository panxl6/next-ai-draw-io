...
import { Github, Info, LogOut, Moon, Sun, Tag } from "lucide-react"
        ...
        <DialogContent className="sm:max-w-lg p-0 gap-0">
            ...
            <div className="px-6 pb-6">
                <div className="divide-y divide-border-subtle">
                    ...
                    {/* Logout */}
                    <SettingItem
                        label={dict.settings.logout || "Logout"}
                        description={
                            dict.settings.logoutDescription ||
                    ...
                    >
                        <Button
                            ...
                            className="h-9 px-4 rounded-xl border-destructive/50 text-destructive hover:bg-destructive/10 hover:text-destructive"
                        >
                            <LogOut className="h-4 w-4 mr-2" />
                            {isLoggingOut
                                ? "..."
                                : dict.settings.logoutButton || "Sign out"}
                        </Button>
                    </SettingItem>
                </div>
            </div>
